...
Para interpretar qué es cada puerto, puede usarse esta
tabla de referencia:
...
| No aparece ningún puerto abierto, aunque se sabe que hay uno activo | El tiempo de espera de 0.05 s fue insuficiente | Repita el escaneo; si persiste, es una limitación conocida del script |
